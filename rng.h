...
inline ulong ULONG32_R(slong x) { return (ulong(x)); }
inline ulong ULONG32_R(ulong x) { return (ulong(x)); }
inline ulong ULONG32_R(double x) { return (ulong(x)); }
inline slong UL32toSL32(ulong x) { return (slong(x)); }
#else
inline ulong ULONG32_R(slong x) { return (ulong(x) & 0xfffffffful); }
inline ulong ULONG32_R(ulong x) { return (x & 0xfffffffful); }
inline ulong ULONG32_R(double x) { return (ulong(x) & 0xfffffffful); }
